...
export const productPhotoController = async (req, res) => {
  try {
    ...
    res.status(500).send({
      success: false,
      message: "Something Went Wrong in product photo",
      error: error.message,
    });
  }
};
...
export const deleteProductController = async (req, res) => {
  try {
    ...
    res.status(500).send({
      success: false,
      message: "Something Went Wrong in product deleting",
      error,
    });
  }
};
...
export const productFilterController = async (req, res) => {
  try {
    ...
    res.status(500).send({
      success: false,
      message: "Something Went Wrong In Filter Product Controller",
      error,
    });
  }
};
...
export const productCountController = async (req, res) => {
  try {
    ...
    res.status(500).send({
      success: false,
      message: "Something Went Wrong In Count Product Controller",
      error,
    });
  }
};
...
export const productPerPageController = async (req, res) => {
  try {
    ...
    res.status(500).send({
      success: false,
      message: "Something Went Wrong in per product page controller",
      error,
    });
  }
};
...
export const productSearchController = async (req, res) => {
  try {
    ...
    res.status(500).send({
      success: false,
      message: "Something Went Wrong in search product controller",
      error,
    });
  }
};

//Related || Similar Product Controller
...
export const productCategoryController = async (req, res) => {
  try {
    ...
    res.status(500).send({
      success: false,
      message: "Something Went Wrong in category wise product controller",
      error,
    });
  }
};
